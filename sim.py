...
motor = Motor(motor_type=MotorType.PermanentMagnetSynchronousMotor, control_type=ControlType.SpeedControl, action_type=ActionType.Continuous)
...
tau = env.unwrapped.physical_system.tau
limits = env.unwrapped.physical_system.limits
